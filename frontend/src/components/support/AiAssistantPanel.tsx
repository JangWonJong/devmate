...
export default function AiAssistantPanel({ onMoveToWrite }: Props) {
...
[추가 요청]
위 내용을 바탕으로 문제 해결 방향에 대해 조언 부탁드립니다.`
            })
  }
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
        ...
        <div className="mt-3 flex items-center justify-between">
          <p className="text-xs text-slate-500">
            문제 상황을 조금 더 구체적으로 적을수록 더 도움이 됩니다.
          </p>
      ...
      {result && (
        <div className="mt-4 flex-1 overflow-y-auto rounded-2xl border border-slate-200 bg-white p-4">
          <div className="space-y-4">
            ...
            <section>
              <h4 className="mb-2 text-sm font-semibold text-slate-900">힌트</h4>
